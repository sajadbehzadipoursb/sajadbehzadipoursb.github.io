...
btn.onclick = function(){
    ...
    if (l != 10){
        ...
        if (r != id.value.substr(9,1)){
            ...
            else if (id.value.substr(0,1)==4, id.value.substr(1,1)==6, id.value.substr(2,1)==8){
                msg1.innerHTML =
                msg1.value = "استان: چهارمحال و بختیاری"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==6, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "استان: چهارمحال و بختیاری"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==6, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: چهارمحال و بختیاری"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==6, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "استان: چهارمحال و بختیاری"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==6, id.value.substr(2,1)==7){
                msg1.innerHTML =
                msg1.value = "استان: چهارمحال و بختیاری"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==3, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "استان: چهارمحال و بختیاری"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==5, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "استان: چهارمحال و بختیاری"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==3, id.value.substr(2,1)==3){
                msg1.innerHTML =
                msg1.value = "استان: چهارمحال و بختیاری"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==2, id.value.substr(2,1)==9){
                msg1.innerHTML =
                msg1.value = "استان: چهارمحال و بختیاری"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==6, id.value.substr(2,1)==6){
                msg1.innerHTML =
                msg1.value = "استان: چهارمحال و بختیاری"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==9, id.value.substr(2,1)==6){
                msg1.innerHTML =
                msg1.value = "استان: چهارمحال و بختیاری"
            }
            // استان خراسان جنوبی
            else if (id.value.substr(0,1)==7, id.value.substr(1,1)==2, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: خراسان جنوبی"
            } else if (id.value.substr(0,1)==0, id.value.substr(1,1)==6, id.value.substr(2,1)==4){
                msg1.innerHTML =
                msg1.value = "استان: خراسان جنوبی"
            } else if (id.value.substr(0,1)==0, id.value.substr(1,1)==6, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "استان: خراسان جنوبی"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==2, id.value.substr(2,1)==3){
                msg1.innerHTML =
                msg1.value = "استان: خراسان جنوبی"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==5, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "استان: خراسان جنوبی"
            } else if (id.value.substr(0,1)==7, id.value.substr(1,1)==1, id.value.substr(2,1)==9){
                msg1.innerHTML =
                msg1.value = "استان: خراسان جنوبی"
            } else if (id.value.substr(0,1)==7, id.value.substr(1,1)==1, id.value.substr(2,1)==6){
                msg1.innerHTML =
                msg1.value = "استان: خراسان جنوبی"
            } else if (id.value.substr(0,1)==0, id.value.substr(1,1)==8, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "استان: خراسان جنوبی"
            } else if (id.value.substr(0,1)==0, id.value.substr(1,1)==8, id.value.substr(2,1)==8){
                msg1.innerHTML =
                msg1.value = "استان: خراسان جنوبی"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==6, id.value.substr(2,1)==3){
                msg1.innerHTML =
                msg1.value = "استان: خراسان جنوبی"
            }
            // استان بوشهر
            else if (id.value.substr(0,1)==5, id.value.substr(1,1)==2, id.value.substr(2,1)==9){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==3, id.value.substr(1,1)==5, id.value.substr(2,1)==3){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==3, id.value.substr(1,1)==4, id.value.substr(2,1)==9){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==3, id.value.substr(1,1)==5, id.value.substr(2,1)==0){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==3, id.value.substr(1,1)==5, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==0, id.value.substr(2,1)==9){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==3, id.value.substr(1,1)==5, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==3, id.value.substr(1,1)==5, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==3, id.value.substr(1,1)==5, id.value.substr(2,1)==4){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==7, id.value.substr(1,1)==3, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==3, id.value.substr(1,1)==5, id.value.substr(2,1)==7){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==3, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==1, id.value.substr(2,1)==0){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            } else if (id.value.substr(0,1)==3, id.value.substr(1,1)==5, id.value.substr(2,1)==6){
                msg1.innerHTML =
                msg1.value = "استان: بوشهر"
            }
            // امورخارجه
            else if (id.value.substr(0,1)==4, id.value.substr(1,1)==7, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "امور خارجه"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==7, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "امور خارجه"
            }
            // استان ایلام
            else if (id.value.substr(0,1)==4, id.value.substr(1,1)==5, id.value.substr(2,1)==4){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==8, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==4, id.value.substr(2,1)==9){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==5, id.value.substr(2,1)==0){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==1, id.value.substr(2,1)==6){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==3, id.value.substr(2,1)==4){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==5, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==5, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            } else if (id.value.substr(0,1)==7, id.value.substr(1,1)==2, id.value.substr(2,1)==6){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==3, id.value.substr(2,1)==4){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==5, id.value.substr(2,1)==3){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            } else if (id.value.substr(0,1)==7, id.value.substr(1,1)==2, id.value.substr(2,1)==7){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==5, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "استان: ایلام"
            }
            // استان اردبیل
            else if (id.value.substr(0,1)==1, id.value.substr(1,1)==4, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==4, id.value.substr(2,1)==6){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==7, id.value.substr(1,1)==3, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==9, id.value.substr(2,1)==0){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==0, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==0, id.value.substr(2,1)==4){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==6, id.value.substr(2,1)==3){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==7, id.value.substr(1,1)==1, id.value.substr(2,1)==4){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==7, id.value.substr(1,1)==1, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==6, id.value.substr(2,1)==6){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==6, id.value.substr(2,1)==6){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==6, id.value.substr(2,1)==7){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==6, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==6, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==8, id.value.substr(2,1)==6){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==0, id.value.substr(2,1)==3){
                msg1.innerHTML =
                msg1.value = "استان: اردبیل"
            }
            // استان اصفهان
            else if (id.value.substr(0,1)==6, id.value.substr(1,1)==1, id.value.substr(2,1)==9){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==1, id.value.substr(2,1)==8){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==2, id.value.substr(2,1)==7){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==2, id.value.substr(2,1)==8){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==2, id.value.substr(2,1)==9){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==2, id.value.substr(2,1)==0){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==2, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==4, id.value.substr(2,1)==9){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==6, id.value.substr(2,1)==4){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==7, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==1, id.value.substr(2,1)==3){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==1, id.value.substr(2,1)==4){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==2, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==4, id.value.substr(2,1)==0){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==6, id.value.substr(2,1)==0){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==2, id.value.substr(2,1)==0){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==1, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==1, id.value.substr(2,1)==0){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==1, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==1, id.value.substr(2,1)==9){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==1, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==1, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==1, id.value.substr(2,1)==0){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==1, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==2, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==2, id.value.substr(2,1)==6){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==6, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==2, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==1, id.value.substr(2,1)==6){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==1, id.value.substr(2,1)==7){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==4, id.value.substr(2,1)==1){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==2, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==2, id.value.substr(2,1)==4){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==0, id.value.substr(2,1)==8){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==0, id.value.substr(2,1)==9){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==2, id.value.substr(2,1)==3){
                msg1.innerHTML =
                msg1.value = "استان: اصفهان"
            }
            // متفرقه
            else if (id.value.substr(0,1)==4, id.value.substr(1,1)==2, id.value.substr(2,1)==7){
                msg1.innerHTML =
                msg1.value = "متفرقه"
            } else if (id.value.substr(0,1)==4, id.value.substr(1,1)==2, id.value.substr(2,1)==8){
                msg1.innerHTML =
                msg1.value = "متفرقه"
            } else if (id.value.substr(0,1)==5, id.value.substr(1,1)==0, id.value.substr(2,1)==7){
                msg1.innerHTML =
                msg1.value = "متفرقه"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==5, id.value.substr(2,1)==8){
                msg1.innerHTML =
                msg1.value = "متفرقه"
            } else if (id.value.substr(0,1)==6, id.value.substr(1,1)==1, id.value.substr(2,1)==5){
                msg1.innerHTML =
                msg1.value = "متفرقه"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==5, id.value.substr(2,1)==3){
                msg1.innerHTML =
                msg1.value = "متفرقه"
            } else if (id.value.substr(0,1)==1, id.value.substr(1,1)==5, id.value.substr(2,1)==2){
                msg1.innerHTML =
                msg1.value = "متفرقه"
            }
            else{
